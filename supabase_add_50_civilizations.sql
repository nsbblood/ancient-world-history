-- =========================================================
-- 50 CIVILIZATIONS - Complete List
-- =========================================================

-- Clear any existing test data (optional - remove if you want to keep)
-- DELETE FROM civilizations WHERE name LIKE 'Ancient%' OR name LIKE 'Kingdom%';
...
('Kingdom of Kush', '1070 BC', '350 AD', 'Africa', 'Nubian kingdom known for powerful queens, pyramids, and trade with Egypt.'),
...
('Ghana Empire', '300 AD', '1200 AD', 'Africa', 'West African empire controlling trans-Saharan gold and salt trade.'),
...
('Hittite Empire', '1600 BC', '1178 BC', 'Anatolia', 'Ancient Anatolian civilization, early masters of iron working and chariot warfare.'),
...
('Achaemenid Empire', '550 BC', '330 BC', 'Persia', 'First Persian Empire under Cyrus the Great, known for religious tolerance and advanced administration.'),
...
('Rapa Nui', '300 AD', '1600 AD', 'Oceania', 'Easter Island culture famous for massive moai stone statues.'),
('Aboriginal Cultures', '50000 BC', 'Present', 'Oceania', 'World''s oldest continuous cultures with rich oral traditions and dreamtime stories.')
